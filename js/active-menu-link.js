!(function (t, e) {
    "object" == typeof exports && "object" == typeof module
        ...
        : "function" == typeof define && define.amd
            ? define("ActiveMenuLink", [], e)
            : "object" == typeof exports
                ? (exports.ActiveMenuLink = e())
                : (t.ActiveMenuLink = e());
})(this, function () {
    return (function (t) {
        var e = {};
                    ...
                    function t(t, e) {
                        ...
                        if (
                            ((this.activeIndex = -1),
                                ...
                                (this.params = { itemTag: "li", activeClass: "active", scrollOffset: 0, scrollDuration: 500, ease: "out-circ", headerHeight: null, default: null, showHash: !0 }),
                                !(t.length < 1))
                        ) {
                            (this.manuSelector = t), (this.params = i(i({}, this.params), e));
                            var r = document.querySelectorAll(this.manuSelector)[0];
                            void 0 !== r &&
                                (null === this.params.headerHeight && (this.params.headerHeight = r.clientHeight),
                                    (this.menu = r),
                                ...
                                t.forEach(function (t, i) {
                                    ...
                                    if (null !== u) {
                                        ...
                                        t.classList.remove(e.params.activeClass),
                                            o !== e.params.default &&
                                            u &&
                                            a <= n + e.params.headerHeight &&
                                            a + r.getAbsoluteHeight(u) > n + e.params.headerHeight &&
                                            (t.classList.add(e.params.activeClass), (e.activeIndex = i), e.unsetDefaultActive());
                                    }
                                }),
                        ...
                        (t.prototype.onClickLinks = function (t) {
                            ...
                            t.forEach(function (t) {
                                ...
                                t.addEventListener("click", function (t) {
                                    ...
                                    if (
                                        (n !== e.params.default && i && (u = i.offsetTop - a - r.getMarginTop(i) - e.params.headerHeight),
                                            n === e.params.default && (u = 0),
                                            null !== u && o(0, u, { ease: e.params.ease, duration: e.params.scrollDuration }),
                                            e.params.showHash)
                                    ) {
                                        var s = "#" + n;
                                        history.pushState && void 0 !== document.origin ? history.pushState(null, null, s) : (location.hash = s);
                                    }
                                });
                            });
                        }),
            ...
            t.exports = function t(e) {
                switch (i(e)) {
                    ...
                    case "array":
                        ...
                        for (var o = 0, u = e.length; o < u; o++) n[o] = t(e[o]);
                        return n;
                    case "regexp":
                        var a = "";
